...
export default function IntegrationMatrix() {
  ...
  const integrations = [
    { name: "GitHub Actions", icon: "🐙", image: "/GitHub Actions.png", glow: "shadow-[0_0_30px_rgba(59,130,246,0.15)]" },
      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-10 md:gap-16">
          {integrations.map((integration) => (
            ...
            >
              <div
                className={`relative flex items-center justify-center w-20 h-20 rounded-2xl bg-zinc-900 border border-zinc-800 transition-all duration-300 group-hover:scale-110 group-hover:-translate-y-1 ${integration.glow}`}
              >
                {integration.image ? (
                  <img
                  ...
                  <span className="text-4xl drop-shadow-lg">{integration.icon}</span>
                )}
              </div>
